    ...
    <div className={styles.container}>
      ...
      <div className={styles.sectionWrapper}>
        ...
        <div className={styles.actionsGrid}>
          {[
            { name: "Transferir", path: ROUTES.TRANSFER, bg: "bg-purple-50", iconColor: "text-purple-600", icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg> },
